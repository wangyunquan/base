...
public class DhtContact  implements Comparable<DhtContact> {
	 private final DhtNode n;
	    ...
	    {
	        if (c instanceof DhtContact)
	        {
	            return ((DhtContact) c).getNode().equals(this.getNode());
	        }
	    ...
	    @Override
	    public int compareTo(DhtContact o)
	    {
