...
<!-- BEGIN THEME STYLES -->
<link href="${ctx}/assets/global/css/components-md.css" id="style_components" rel="stylesheet" type="text/css"/>
<link href="${ctx}/assets/global/css/plugins-md.css" rel="stylesheet" type="text/css"/>
...
<div class="page-header md-shadow-z-1-i navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="${ctx}/assets/admin/layout4/img/logo-light.png" alt="logo" class="logo-default"/>
			</a>
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-language">
						<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						<img alt="" src="${ctx}/assets/global/img/flags/us.png">
						<span class="langname">
						US </span>
						...
						<ul class="dropdown-menu">
							<li>
								<a href="javascript:;">
								<img alt="" src="${ctx}/assets/global/img/flags/es.png"> Spanish </a>
							</li>
							<li>
								<a href="javascript:;">
								<img alt="" src="${ctx}/assets/global/img/flags/de.png"> German </a>
							</li>
							<li>
								<a href="javascript:;">
								<img alt="" src="${ctx}/assets/global/img/flags/ru.png"> Russian </a>
							</li>
							<li>
								<a href="javascript:;">
								<img alt="" src="${ctx}/assets/global/img/flags/fr.png"> French </a>
							</li>
						</ul>
					</li>
					<!-- END LANGUAGE BAR -->
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>Language Switch Bar <small>page sample with language switch bar</small></h1>
				</div>
				<!-- END PAGE TITLE -->
				<!-- BEGIN PAGE TOOLBAR -->
