				...
				<div class="panel panel-info ">
                  ...
                  <tbody>
                    ...
                    <tr>
                 	...
                 	<td>
										<a class="btn btn-xs btn-info" type="button" href="input?id=${item.id }&siteId=${siteId}"> <span	class="glyphicon glyphicon-new-window"></span>修改</a> 
										<a class="btn btn-xs btn-default" type="button" 	href="javascript:deleteConfirm('delete?id=${item.id}&siteId=${siteId}');"> <span class="glyphicon glyphicon-remove"></span>删除</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
