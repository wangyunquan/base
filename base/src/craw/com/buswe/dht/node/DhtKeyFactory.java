 ...
 * 
 */
public final class DhtKeyFactory {
	private final int keyByteLength;
	private final Random rnd;
	private final MessageDigest md;
	private static DhtKeyFactory instance;

	public static final DhtKeyFactory getInstance() {
		if (instance == null) {
			try {
				instance = new DhtKeyFactory(20, new Random(), "SHA-1");
	 ...
	 */
	private DhtKeyFactory(final int keyByteLength, final Random rnd, final String hashAlgo)
			throws NoSuchAlgorithmException {
	...
	public Key get(final String base64Encoded) {
		...
		final byte[] decodeBase64 = base64Encoded.getBytes();
